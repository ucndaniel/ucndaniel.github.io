...
const hotspots = [
    ...
    //hotspots for small circles
    {
        ...
        ui:  {
           choiceCircle, 
            type: "box",
            style: `border-radius: 50%; position: absolute; color: rgba(0, 0, 0, 0); background-color: #F7403A;`,
            // text: "hovedindgang"
        },
        hotspot: {
            type: "function",
    ...
    },
    {
        ...
        ui:  {
            choiceCircle, 
             type: "box",
             style: `border-radius: 50%; position: absolute; color: rgba(0, 0, 0, 0); background-color: #668e96;`,
             // text: "Servicecenter"
         },
        hotspot: {
            type: "function",
...

    {
        ...
        ui:  {
            choiceCircle, 
             type: "box",
             style: `border-radius: 50%; position: absolute; color: rgba(0, 0, 0, 0); background-color: #222221;`,
    ...
    },
    {
        ...
        ui:  {
            choiceCircle, 
             type: "box",
             style: `border-radius: 50%; position: absolute; color: rgba(0, 0, 0, 0); background-color: #004250;`,
    ...
    },
    {
        ...
        ui:  {
            choiceCircle, 
             type: "box",
             style: `border-radius: 50%; position: absolute; color: rgba(0, 0, 0, 0); background-color: #6690CE;`,
             // text: "fredagsbar"
         },
        hotspot: {
            type: "function",
            func: () => {
                // studievejledning 4 circel // ændres til fredagsbar ~
                videoPlayer.currentTime(221.4);
                videoPlayer.play();
                pauseTime = 258.3;
                window.scrollTo(0, -100);
    ...
    },
    {
        ...
        ui:  {
            choiceCircle, 
             type: "box",
             style: `border-radius: 50%; position: absolute; color: rgba(0, 0, 0, 0); background-color: #0046AD;`,
             // text: "faglokale"
         },
        hotspot: {
            type: "function",
...

    {
        ...
        hotspot: {
            type: "function",
            func: () => {
                // gruppeområde 1 circel // ændres til faglokale
                videoPlayer.currentTime(73.1);
                videoPlayer.play();
                pauseTime = 124.7;
                window.scrollTo(0, -100);
    ...
    },
    {
        ...
        ui:  {
            choiceCircle, 
             type: "box",
             style: `border-radius: 50%; position: absolute; color: rgba(0, 0, 0, 0); background-color: #BED6DB;`,
             // text: "Gruppeområde"
         },
        hotspot: {
            type: "function",
            func: () => {
                // gruppeområde 2 circle // ændres til faglokale // ændres til gruppeområde
                videoPlayer.currentTime(128.4);
                videoPlayer.play();
                pauseTime = 144.9;
                window.scrollTo(0, -100);
...

    {
        ...
        hotspot: {
            type: "function",
            func: () => {
                // audietorie circle // ændres til gruppeområde
                videoPlayer.currentTime(128.4);
                videoPlayer.play();
                pauseTime = 144.9;
                window.scrollTo(0, -100);
...

{
        ...
        hotspot: {
            type: "function",
            func: () => {
                // bibliotek circle // ændres til gruppeområde
                videoPlayer.currentTime(128.4);
                videoPlayer.play();
                pauseTime = 144.9;
                window.scrollTo(0, -100);
    ...
    },
    {
        ...
        hotspot: {
            type: "function",
            func: () => {
                // internationalt kontor circle // ændres til gruppeområde
                videoPlayer.currentTime(128.4);
                videoPlayer.play();
                pauseTime = 144.9;
                window.scrollTo(0, -100);
    ...
    },
    {
        ...
        ui:  {
            choiceCircle, 
             type: "box",
             style: `border-radius: 50%; position: absolute; color: rgba(0, 0, 0, 0); background-color: #fa8c89;`,
             // text: "kantine"
         },
        hotspot: {
            type: "function",
            func: () => {
                // gruppeområde // ændres til kantine
                videoPlayer.currentTime(176.9);
                videoPlayer.play();
                pauseTime = 202.2;
                window.scrollTo(0, -100);
...

    {
        ...
        ui:  {
            choiceCircle, 
             type: "box",
             style: `border-radius: 50%; position: absolute; color: rgba(0, 0, 0, 0); background-color: #ffcb4f;`,
             // text: "bibliotek"
         },
        hotspot: {
            type: "function",
...

    {
        ...
        ui:  {
            choiceCircle, 
             type: "box",
             style: `border-radius: 50%; position: absolute; color: rgba(0, 0, 0, 0); background-color: #ffe5a7;`,
             // text: "Internationalt kontor"
         },
        hotspot: {
            type: "function",
            func: () => {
                // Internationalt kontor circle // ændres til auditorium
                videoPlayer.currentTime(205.8);
                videoPlayer.play();
                pauseTime = 218;
                window.scrollTo(0, -100);
    ...
    // BACK TO MAP HOTSPOT(S)

// permanent "tilbage til kortet" punkt
{
    active: true,
    videoId: "video1",
    markIn: 5,
