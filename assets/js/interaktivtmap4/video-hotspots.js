...
const hotspots = [
    ...
    //hotspots for small circles
    {
        ...
        ui:  {
           choiceCircle, 
            type: "box",
            style: `border-radius: 50%; position: absolute; color: rgba(0, 0, 0, 0); background-color: red; background-color: red;`,
            // text: "hovedindgang"
        },
        hotspot: {
            type: "function",
    ...
    },
    {
        ...
        ui:  {
           choiceCircle, 
            type: "box",
            style: `border-radius: 50%; position: absolute; color: rgba(0, 0, 0, 0); background-color: red;`,
            // text: "hovedindgang"
        },
        hotspot: {
            type: "function",
    ...
    },
    {
        ...
        hotspot: {
            type: "function",
            func: () => {
                // gruppeområde 2 circle // ændres til fredagsbar
                videoPlayer.currentTime(239.5);
                videoPlayer.play();
                pauseTime = 260;
                window.scrollTo(0, -100);
